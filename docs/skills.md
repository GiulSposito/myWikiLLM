...
O pacote foi criado para agentes compatíveis com o padrão Agent Skills, incluindo Claude Code. A instalação pode ser feita pelo marketplace do Claude Code, por `npx skills`, ou copiando o conteúdo para `.claude` no vault. ([GitHub](https://github.com/kepano/obsidian-skills "GitHub - kepano/obsidian-skills: Agent skills for Obsidian. Teach your agent to use Obsidian CLI and open formats including Markdown, Bases, JSON Canvas. · GitHub"))
...
Ela é fundacional porque Markdown “quase correto” pode parecer normal no GitHub, mas quebrar backlinks, embeds e o graph do Obsidian. ([GitHub](https://github.com/kepano/obsidian-skills "GitHub - kepano/obsidian-skills: Agent skills for Obsidian. Teach your agent to use Obsidian CLI and open formats including Markdown, Bases, JSON Canvas. · GitHub"))
...
Essa skill pode substituir parte do uso do Dataview em dashboards mais novos do Obsidian. ([GitHub](https://github.com/kepano/obsidian-skills "GitHub - kepano/obsidian-skills: Agent skills for Obsidian. Teach your agent to use Obsidian CLI and open formats including Markdown, Bases, JSON Canvas. · GitHub"))
...
Isso permite gerar mapas conceituais navegáveis usando o formato aberto JSON Canvas. ([GitHub](https://github.com/kepano/obsidian-skills "GitHub - kepano/obsidian-skills: Agent skills for Obsidian. Teach your agent to use Obsidian CLI and open formats including Markdown, Bases, JSON Canvas. · GitHub"))

### `obsidian-cli`

Dá ao Claude uma forma controlada de operar o vault por meio do CLI do Obsidian, inclusive para pesquisar notas e trabalhar com plugins e temas. ([GitHub](https://github.com/kepano/obsidian-skills "GitHub - kepano/obsidian-skills: Agent skills for Obsidian. Teach your agent to use Obsidian CLI and open formats including Markdown, Bases, JSON Canvas. · GitHub"))

### `defuddle`

Extrai conteúdo limpo de páginas web, removendo navegação, anúncios e outros elementos irrelevantes antes de salvar em Markdown. Isso reduz ruído e consumo de contexto. ([GitHub](https://github.com/kepano/obsidian-skills "GitHub - kepano/obsidian-skills: Agent skills for Obsidian. Teach your agent to use Obsidian CLI and open formats including Markdown, Bases, JSON Canvas. · GitHub"))
...
([GitHub](https://github.com/kepano/obsidian-skills "GitHub - kepano/obsidian-skills: Agent skills for Obsidian. Teach your agent to use Obsidian CLI and open formats including Markdown, Bases, JSON Canvas. · GitHub"))
...
Ele foi construído especificamente para Claude Code + Obsidian. ([GitHub](https://github.com/axtonliu/axton-obsidian-visual-skills "GitHub - axtonliu/axton-obsidian-visual-skills: Visual Skills Pack for Obsidian: generate Canvas, Excalidraw, and Mermaid diagrams from text with Claude Code · GitHub"))
...
Suporta flowcharts, mind maps, hierarquias, mapas de relações, comparações, timelines, matrizes e layouts livres. ([GitHub](https://github.com/axtonliu/axton-obsidian-visual-skills "GitHub - axtonliu/axton-obsidian-visual-skills: Visual Skills Pack for Obsidian: generate Canvas, Excalidraw, and Mermaid diagrams from text with Claude Code · GitHub"))
...
O pacote inclui instruções para reduzir erros comuns de sintaxe Mermaid. ([GitHub](https://github.com/axtonliu/axton-obsidian-visual-skills?utm_source=chatgpt.com "axtonliu/axton-obsidian-visual-skills - GitHub"))

## Canvas

A skill Canvas gera um `.canvas` nativo do Obsidian. Isso é especialmente interessante para sua wiki porque os nós podem ser **as próprias páginas reais da base**, não apenas caixas desenhadas. ([GitHub](https://github.com/axtonliu/axton-obsidian-visual-skills/tree/main/obsidian-canvas-creator?utm_source=chatgpt.com "axton-obsidian-visual-skills/obsidian-canvas-creator at main · axtonliu ..."))
...
O próprio mantenedor classifica o Visual Skills Pack como experimental: a qualidade pode variar conforme o modelo e a complexidade da entrada, e o projeto não cobre todos os casos extremos. ([GitHub](https://github.com/axtonliu/axton-obsidian-visual-skills "GitHub - axtonliu/axton-obsidian-visual-skills: Visual Skills Pack for Obsidian: generate Canvas, Excalidraw, and Mermaid diagrams from text with Claude Code · GitHub"))
...
Esse projeto é mais especializado. Ele cobre o schema do Excalidraw e gera arquivos `.md` que abrem diretamente no plugin Excalidraw do Obsidian. Suporta fluxogramas, mind maps, arquitetura, ER, network diagrams, timelines, matrizes e alguns tipos de gráfico. ([GitHub](https://github.com/secemp9/excalidraw_skill "GitHub - secemp9/excalidraw_skill: Excalidraw diagram generation skill for Claude Code - generates Obsidian-compatible .md files with full Excalidraw JSON · GitHub"))
...
([GitHub](https://github.com/secemp9/excalidraw_skill "GitHub - secemp9/excalidraw_skill: Excalidraw diagram generation skill for Claude Code - generates Obsidian-compatible .md files with full Excalidraw JSON · GitHub"))
...
O agente consegue desenhar, observar por screenshot, identificar sobreposições e corrigir o arquivo antes de exportar. ([GitHub](https://github.com/yctimlin/mcp_excalidraw "GitHub - yctimlin/mcp_excalidraw: MCP server and Claude Code skill for Excalidraw — programmatic canvas toolkit to create, edit, and export diagrams via AI agents with real-time canvas sync. · GitHub"))

A execução principal é local, requer Node.js 18 ou superior e não necessita de API key adicional. ([GitHub](https://github.com/yctimlin/mcp_excalidraw "GitHub - yctimlin/mcp_excalidraw: MCP server and Claude Code skill for Excalidraw — programmatic canvas toolkit to create, edit, and export diagrams via AI agents with real-time canvas sync. · GitHub"))
...
([GitHub](https://github.com/yctimlin/mcp_excalidraw "GitHub - yctimlin/mcp_excalidraw: MCP server and Claude Code skill for Excalidraw — programmatic canvas toolkit to create, edit, and export diagrams via AI agents with real-time canvas sync. · GitHub"))
...
Ele lê skills em `~/.claude/skills/` e executa o Claude Code usando o diretório configurado como contexto de trabalho. ([Obsidian Community](https://community.obsidian.md/plugins/claude-code-skills "Claude Code Skills - Obsidian Plugin"))
...
É desktop-only e executa o CLI localmente. A comunicação externa ocorre por meio do próprio Claude Code CLI. ([Obsidian Community](https://community.obsidian.md/plugins/claude-code-skills "Claude Code Skills - Obsidian Plugin"))
...
Ele suporta múltiplas fontes de pesquisa, integração com Zotero, deduplicação, notas no padrão Karpathy, conceitos atômicos, sínteses, comparações, contradições e questões abertas. Os resultados possuem frontmatter compatível com Dataview e fórmulas MathJax. ([GitHub](https://github.com/Geek96/paper-research-skill?utm_source=chatgpt.com "GitHub - Geek96/paper-research-skill: A modular Claude Code skill for ..."))
...
Ela lê papers do Zotero, cria uma nota canônica por paper, gera sínteses conceituais e pode produzir um Canvas da estrutura da literatura. ([GitHub](https://github.com/AcWiz/my-claude-scholar/blob/main/skills/zotero-obsidian-bridge/SKILL.md?utm_source=chatgpt.com "my-claude-scholar/skills/zotero-obsidian-bridge/SKILL.md at main ..."))
...
O `defuddle` já cobre boa parte da limpeza de páginas web. ([GitHub](https://github.com/kepano/obsidian-skills "GitHub - kepano/obsidian-skills: Agent skills for Obsidian. Teach your agent to use Obsidian CLI and open formats including Markdown, Bases, JSON Canvas. · GitHub"))
...
Há projetos como `obsidian-paper-vault-skill` que fazem ingestão em lote de PDFs, geram frontmatter Dataview, embeds dos PDFs, notas padronizadas e conceitos atômicos. ([GitHub](https://github.com/podkd7226/obsidian-paper-vault-skill?utm_source=chatgpt.com "GitHub - podkd7226/obsidian-paper-vault-skill: Claude Code skill ..."))
...
A skill `obsidian-bases` já cobre criação e edição de views, filtros, fórmulas e summaries. ([GitHub](https://github.com/kepano/obsidian-skills "GitHub - kepano/obsidian-skills: Agent skills for Obsidian. Teach your agent to use Obsidian CLI and open formats including Markdown, Bases, JSON Canvas. · GitHub"))
...
Há coleções amplas de skills para Claude Code. Uma delas anuncia centenas de skills em áreas como engenharia, pesquisa, compliance, estratégia, marketing, gestão e documentação. ([GitHub](https://github.com/alirezarezvani/claude-skills?utm_source=chatgpt.com "GitHub - alirezarezvani/claude-skills: 345 Claude Code skills & agent ..."))
...
Também existem riscos de segurança em skills públicas, especialmente quando incluem scripts, comandos de sistema ou acesso externo. Pesquisas recentes sobre o ecossistema encontraram grande redundância entre skills e riscos não triviais em módulos capazes de alterar o sistema. ([arXiv](https://arxiv.org/abs/2602.08004?utm_source=chatgpt.com "Agent Skills: A Data-Driven Analysis of Claude Skills for Extending Large Language Model Functionality"))
